...
一键配置您的 AI 编码工具 — Claude Code / Cursor / Continue.dev / GitHub Copilot
...
3. **选择 AI 编码工具** — 多选：Claude Code / Cursor / Continue.dev / GitHub Copilot
...
| **Cursor** | 📝 | `~/.cursor/cic-config.json` |
| **Continue.dev** | 🔌 | `~/.continue/cic-config.json` |
| **GitHub Copilot** | 👾 | `~/.config/github-copilot/cic-hosts.json` |
| **OpenCode** | 📂 | `~/.config/opencode/config.json` |
| **Crush** | 💥 | `~/.config/crush/config.json` |
| **Factory Droid** | 🏭 | `~/.config/factory/droid/config.json` |
