...
<p align="center">
  <a href="https://www.npmjs.com/package/cic-ai-config-helper"><img src="https://img.shields.io/npm/v/cic-ai-config-helper.svg?logo=npm&label=npm" alt="npm 包版本"></a>
  <a href="https://www.npmjs.com/package/cic-ai-config-helper"><img src="https://img.shields.io/npm/dm/cic-ai-config-helper.svg?logo=npm&label=downloads" alt="npm 下载量"></a>
</p>

<p align="center">
  <a href="https://www.npmjs.com/package/cic-ai-config-helper">在 npm 查看此包</a> · <a href="README.md">English</a>
</p>

一键配置您的 AI 编码工具 — Claude Code / Codex / Hermes / OpenCode
...
3. **选择 AI 编码工具** — 多选：Claude Code / Codex / Hermes / OpenCode 等
